...
<picture>
    ...
    <img align="right" width="50%" src="https://github-readme-streak-stats.herokuapp.com?user=skriptzip&hide_border=true">
</picture>

-   :pencil2: Java / C / TypeScript / React / Python 
-   :package: [Arch Linux](https://wiki.archlinux.org/title/Arch_Linux) / [Windows](https://www.microsoft.com/de-de/software-download/windows11/) / [WSL](https://learn.microsoft.com/de-de/windows/wsl/install/) / [neovim](https://neovim.io/) / [VS Code](https://code.visualstudio.com/) / [Zen](https://zen-browser.app/) 
-   :microscope:  ESP32-S3 Microcontroller with C / Micropython
-   :calendar: Coding since 2019
-   :seedling: Always learning something new
-   :brain: Thinking in functions, dreaming in loops
-   :globe_with_meridians: Website: [`skript.zip`](https://skript.zip)
